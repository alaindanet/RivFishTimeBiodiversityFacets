...
levels(tot_tab$basin_name_f)
unique(tot_tab$ecoregion)
lvl_basin <- c(
  "(i) Logan (16)",
  "(h) Brisbane (52)",
  "(g) Murray Darling (82)",
...
fig3 <- plot_grid(
  plot_grid(main_map_rect_basin, leg_cl, align = "h", axis = "lr", rel_widths = c(1, .2), nrow = 1),
  plot_grid(fig3_bottom_left3, p_tot_tab, nrow = 1, rel_widths = c(1, .7)),
  ncol = 1
  )
ggsave(
  filename = "fig3.pdf",
