...
cp ../fig_paper/p_effect_supp.pdf extended_data/Danet_ED_Fig7.pdf
cp ../fig_paper/p_pca_riv_str.pdf extended_data/Danet_ED_Fig8.png
...
# Supplementary Data
zip -r Danet_Supplementary_Data_1.zip ../fig_paper/SupplementaryMap
