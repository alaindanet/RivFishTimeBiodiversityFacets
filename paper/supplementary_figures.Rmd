...
legend_order <- c(
  ...
  "hillebrand_dis_scaled", "turnover_scaled", "perc_exo_abun", "perc_exo_sp",
  "jaccard_dis_scaled", "nestedness_scaled", "appearance_scaled",
...
restricted_dimension <- c(
  "log_total_abundance", "log_chao_richness", "hillebrand_dis_scaled",
  "turnover_scaled", "perc_exo_abun", "perc_exo_sp"
)
```
