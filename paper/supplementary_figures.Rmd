...
```{r base-span-cpl, fig.cap=cap, out.width = "80%", out.height = "95%"}
...
```{r trends-site, fig.cap=cov_ts_site_cap, fig.asp = 1.1, out.width = "80%"}
...
pca_clust_cap <- paste0("**Covariation among the community temporal trends and
  ...
  distribution of the temporal trends by cluster. (d) Cluster frequencies across
...
```{r drivers-ts, fig.cap=drivers_ts_cap, fig.asp = 1.1, out.width = "80%"}
