...
add_dataset_ref %>%
  ...
  kbl(
    ...
    booktabs = T,
    label = "tab-add-data",
    caption = "References of the dataset included in the study, arranged by countries which have the more sites in our study. Numeric Source id correspond to the id of RivFishTIME database (Comte et al.,
