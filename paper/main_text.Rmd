...
pressures and was mediated by non-native species introductions. Specifically, we
...
S1). For example, on average the Thames basin show the same patterns than at the
