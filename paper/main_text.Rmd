...
surveys were realized before this date (Fig. S3), and the effect of recent
...
much more higher than the one captured by the fixed effects (Table SXX).
...
species and community composition (Table S7).  Total abundance was reported in
