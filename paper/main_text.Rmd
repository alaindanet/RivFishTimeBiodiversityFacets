...
`r exo_trends[["perc_exo_abun"]]` per decade), and no evidence for a trend in
the proportion of non-native species richness (CI 80%: `r exo_trends[["perc_exo_sp"]]`
per decade). We also
...
turnover. Points depict the average of posterior distribution. Large, medium
