...
Human pressures constitute a major driver of global biodiversity declines. Yet,
local community responses are more contrasted, especially in freshwater systems
where recent increases in abundance and occupancy were reported. We analyzed a
compilation of riverine fish community timeseries across three biogeographic
realms to quantify the effects of anthropogenic pressures on community
trajectories over space and time. Our results reveal a global increase in total
abundance and species richness of 13% and 7% per decade respectively, driven by
historical anthropogenic pressures which were associated with an increasing
share of non-native species, strong changes in species identity and dominance,
consistent with previously reported biotic homogenization at larger scales.
However, we also found a low covariation among biodiversity facets and a high
spatial heterogeneity in community trajectory at the site scale. We further show
that the antagonistic and synergistic interactions between the degree of past
and recent anthropogenic pressures as well as the spatial position along the
stream gradient can explain the high degree of spatial heterogeneity and the
multidimensional nature of biodiversity changes. Our study highlights that
considering the timing and degree of anthropogenic pressures, species identity,
together with multiple biodiversity facets is crucial to understand community
reorganization.

# Introduction (up to 500 words / 498 words)

Whereas global biodiversity is reported to decline at an alarming
rate[@diaz_global_2019], local biodiversity shows no net change in species
richness over time in marine and terrestrial assemblages[@vellend_global_2013;
@dornelas_assemblage_2014; @blowes_geography_2019], less alarming
declines, and even recovery in freshwater systems[@van_klink_meta-analysis_2020;
@outhwaite_complex_2020]. Those contrasting biodiversity trends call for further
investigations to better understand how ecological communities change at local
scale.

Habitat degradation is recognized as one of the main drivers of biodiversity
losses across ecosystems[@diaz_global_2019; @caro_inconvenient_2022;
@maxwell_biodiversity_2016]. Dense urban and cultivated areas are generally
associated with reduced species richness and total abundance in both
vertebrates[@newbold_global_2015] and invertebrates[@outhwaite_agriculture_2022;
@chen_threshold_2020]. Human activities can also alter local community
composition by favoring tolerant and ubiquitous species that can cope with
degraded habitats[@tonella_importance_2018; @su_morphological_2020]. In
particular, non-native species can play a disproportionate role in the
recomposition of ecological communities over time[@leprieur_fish_2008;
@bernery_freshwater_2022; @villeger_homogenization_2011], and have dramatic
effects on assemblages when they become invasive[@gallardo_global_2016].
Anthropogenic pressures may therefore have antagonistic effects on local
diversity because habitat degradation is expected to decrease species richness
and total abundance, while the introductions of non-native species are expected
to increase species richness and total abundance.

An additional consideration is that anthropogenic pressures are highly
heterogeneous across space and time. For instance, places such as Europe and
Northeastern America have been under the highest historical human influence,
i.e. in terms of population density, of cropland and urban areas, and built
infrastructures in general[@sanderson_human_2002], but it is in more recently
industrialized places, which are also the locations of most biodiversity
hotspots, that human pressures increased the most dramatically over the last
decades[@venter_sixteen_2016]. Taking into account the spatial and temporal
distribution of human pressures might thus help to disentangle biodiversity
responses due to legacy effects from the ones related to recent changes in
anthropogenic pressures. The multidimensional nature of community
changes[@lyashevska_how_2012; @chase_embracing_2018] constitutes another layer
of complexity, as temporal trends in species richness can be unrelated to
changes in other aspects of community composition[@dornelas_assemblage_2014;
@blowes_geography_2019; @scott_native_2001; @hillebrand_biodiversity_2018].
Thus, a better understanding of the processes underlying community
reorganization may require the use of multiple indices capturing changes in
abundance but also in species identity.

Freshwater systems constitute a timely case because they cover a small area of
terrestrial land but are considered as among the most endangered systems on the
planet, being the recipients of the pollution from byproducts of human
activities[@reid_emerging_2019], and showing particularly high levels of
non-native species introductions, among other threats[@leprieur_fish_2008]. This
contrasts with recent reports of increases in abundance and occupancy in
freshwater invertebrate assemblages over the last
decades[@van_klink_meta-analysis_2020; @outhwaite_complex_2020], which calls for
further investigations of community changes in freshwater systems. This study
addresses those research gaps by investigating the effects of both past and
recent changes in anthropogenic pressures on community changes over the last
decades, including total abundance, species richness, share of non-native
species, and changes in community composition, in riverine fish communities
across three biogeographic realms. We quantified anthropogenic pressures using
the human footprint index, a cumulative index including infrastructures,
urbanization and agricultural land use and population
density[@sanderson_human_2002], and which has been previously related to species
extinction and biological invasion risks[@di_marco_changes_2018;
@gallardo_importance_2015].
...
Our dataset comprised 4476 riverine fish community timeseries that had been
repeatedly sampled over the last three decades (baseline: `r tss$min`; span: `r
tss$span` years; completeness:`r tss$completeness`; median [25th quantile,75th
quantile]), mainly in Western and Northern Europe, Northeastern America,
Southeastern Australia and Japan. We found an overall increase in total
abundance and species richness, together with strong changes in community
composition. We derived estimates of community changes from a hierarchical
Bayesian model including the number of years since the first survey as sole
predictor, as well as hydrographic basin and sites nested within basins as
random effects. More specifically, our results indicated strong evidence for a
global increase over time in total abundance (average: `r abun_trends` per
decade [Credible Interval 95%], Fig. S1) and in species richness (CI 95%:
`r rich_trends` per decade). We further found moderate evidence for a global
decline in the proportion of non-native species abundance (CI
90%: `r exo_trends[["perc_exo_abun"]]` per decade), but no evidence for a net
temporal trend in the proportion of non-native species richness (CI 80%:
`r exo_trends[["perc_exo_sp"]]` per decade). We found strong evidence of fast
community reorganization, with a decline in similarity of about 30% per decade
when considering either species relative abundances (Simpson dissimilarity,
CI 95%: `r hill_trends` per decade, hereafter “temporal dissimilarity”) or
occurrences (Jaccard dissimilarity, CI 95%: `r jac_trends` per decade).
...
common pool, displayed a comparable increase over time (CI 95%: `r tu_trends`
per decade), corresponding to an equal share from the rate of increase of the
Jaccard dissimilarity index (Fig. S2). Together, it indicated that changes in
community composition were related to changes in species richness and species
...
community metrics as illustrated by a principal component analysis (PCA).
Whereas temporal trends in community composition, i.e. dissimilarity and
turnover, appeared largely independent from temporal trends in species richness
and total abundance (axes 1 & 2; Fig. 1a), the PCA also revealed that species
richness and total abundance as well as temporal dissimilarity and turnover tend
to be negatively associated (axes 3 & 4; Fig. 1b). A clustering analysis using a
k-mean trimmed clustering method further revealed the existence of six distinct
types of community trajectories. Around 40% of the sites were attributed to a
cluster associated with medium temporal increases in species richness and total
abundance, as well as medium temporal trends in dissimilarity and turnover
(‘medium change’; Fig. 1c). The second cluster was related to communities
displaying a high turnover but moderate increases in species richness, total
abundance and dissimilarity over time (‘high turnover’; 16% of the sites; Fig.
1c). The third, fourth and fifth clusters (resp. 13%, 12% and 9% of the sites,
Fig. 1c) were related to temporal changes along a single dimension: a main
increase in species richness over time (‘increase in species richness’), a main
decline in total abundance (‘decrease in total abundance’) and a main decline in
species richness (‘decrease in species richness’), respectively. The last
cluster (7% of the sites) was related to communities that remained relatively
stable over time (‘low change’). Importantly, the different community
trajectories were observed across all biogeographic realms with similar
frequencies but showed basin-specific patterns (Fig. 2a-b). For instance, the
Potomac basin (U.S., Fig. 2c) displayed relatively few sites displaying declines
in total abundance but a much higher proportion of sites displaying a strong
turnover, i.e. species replacement. The Thames basin (U.K., Fig. 2d) also
displayed a lower proportion of sites corresponding to low community changes and
instead a higher proportion of sites displaying a decrease in species richness
and total abundance. We further found that for all community metrics, the
variance in the temporal trends was up to twice higher for the site identity
(nested within basins) than for the hydrographic basin identity (Table 1),
indicating that the biodiversity changes varied more within than between basins.
...
We assessed the drivers of community changes over time using the same
hierarchical Bayesian models including hydrographic basin and site identity
nested within basins as random effects, but including the position along the
stream gradient as well as the degree of past and recent anthropogenic pressures
and their interactions as fixed effects. The position along the stream gradient,
from upstream to downstream, was summarized using a PCA axis positively related
Strahler order, distance from source, and annual discharge, with large values
indicating downstream areas. We quantified the legacy of past anthropogenic
pressures with the human footprint index of 1993, as only 7% of the monitoring
surveys were realized before this date (Fig. S4), and the effect of recent
anthropogenic pressures by the ratio of the human footprint index between 2009
and 1993. Overall, the hierarchical spatial structure of the models captured
well the variance in the community metrics, as the R² conditional on the
random intercepts varied from `r r2turn` (average [CI 95%]) for turnover
to `r r2rich` for species richness (Table 1). However, the marginal R² were much
lower than the R² conditional on the random intercept, indicating that the
variance in community metrics captured by the hierarchical random effects was
much more higher than the one captured by the fixed effects (Table S1).

We also found strong evidence that a higher degree of past anthropogenic
pressures was associated with faster rates of total abundance and species
richness increases (resp. CI 95%:$\beta\prime =$ `r hft93abun` in blue and
`r hft93rich` in green, Fig. 3a), but this effect was reduced in more downstream
areas (resp. CI 80%:$\beta\prime =$ `r rivhftabun` and CI 95%: $\beta\prime =$
`r rivhftrich`, Fig. 3b). We also found some evidence that a higher degree of past
anthropogenic pressures was associated with an increase in the proportion of
non-native richness over time (CI 80%:$\beta\prime =$ `r hft93exor`, yellow, Fig. 3a),
and that this effect was enhanced in more downstream areas (CI 90%:$\beta\prime
=$ `r rivhftexor`, Fig. 3b).  Although we did not find evidence of an overall
effect of past anthropogenic pressures on the rate of changes in non-native
species abundance (CI 80%:$\beta\prime =$ `r hft93exoa` in orange, Fig. 3a), we
found moderate evidence that a higher degree of past anthropogenic pressures
resulted in a higher rate of increase in non-native species abundance in the
most downstream areas (CI 90%:$\beta\prime =$ `r rivhftexoa`, Fig. 3b).
Furthermore, we found strong evidence that a higher degree of past anthropogenic
pressures was associated with an increased rate in temporal dissimilarity and
turnover (resp. CI 95%:$\beta\prime =$ `r hft93hill` in red and `r hft93turn` in
purple, Fig. 3a), although we found no  evidence that these effects varied along
the stream gradient (resp. CI 80%:$\beta\prime =$ `r rivhfthill` and
`r rivhftturn`, Fig. 3b). We found strong evidence that the stream gradient had
an overall effect on the rate of biodiversity changes over time, such as
downstream areas experienced faster rates of changes for all the metrics
considered: total abundance (CI 95%:$\beta\prime =$ `r riv1abun`, Fig. 3a), species
richness (`r riv1rich`), proportion of non-native species richness (`r riv1exor`),
proportion of non-native abundance (`r riv1exoa`), temporal
dissimilarity (`r riv1hill`) and turnover (`r riv1turn`).

Although we did not find evidence of an overall effect of recent anthropogenic
pressures, on the temporal trends in total abundance (CI 80%:$\beta\prime =$ 
`r hft09abun`, Fig. 3a), but we found strong evidence for an antagonistic effect
between past and recent anthropogenic changes (CI 95%:$\beta\prime =$ 
`r hft2abun`, Fig. 3b), such as the rate of increase in total abundance observed
across the historically most degraded sites was lower when these sites
experienced a recent increase in anthropogenic pressures. We also did not find
evidence that recent anthropogenic changes had an effect on the temporal trends
in species richness (CI 80%:$\beta\prime =$ `r hft09rich`, Fig. 3a), except
through an interaction with the stream gradient (CI 90%:$\beta\prime =$
`r rivhft09rich`, Fig. 3b), such as recent increases in anthropogenic pressures
resulted in faster increases in species richness over time in downstream areas.
In contrast, we found moderate evidence that a recent increase in anthropogenic
pressures was associated with an increase in the proportion of non-native
species richness over time (CI 90%:$\beta\prime =$ `r hft09exor`, Fig. 3a), with
an effect even higher in the historically most degraded sites and in the most
downstream areas(resp. CI 90%:$\beta\prime =$ `r hft2exor` and `r rivhft09exor`,
Fig. 3b).  Similarly, we found moderate evidence that a recent increase in
anthropogenic pressures resulted in a higher increase in the proportion of
non-native species abundance over time in the most downstream sites (CI
90%:$\beta\prime =$ `r rivhft09exoa`, Fig. 3b), despite finding no evidence for
an overall effect of recent changes in anthropogenic pressures (CI 80%:
...
`r hft09turn`, Fig. 3a), an effect hastened in the most historically degraded
sites (resp. CI 95%:$\beta\prime =$ `r hft2hill` and `r hft2turn`, Fig. 3b), but
not affected by the position of the sites along the stream gradient (resp. CI
80%:$\beta\prime =$ `r rivhft09hill` and `r rivhft09turn`).


## Drivers of spatial community changes 

Finally, we found evidence that the different biodiversity facets varied across
space. We found strong evidence that a higher degree of past anthropogenic
pressures was associated with lower total abundance (Fig. 3c), with the
most degraded sites (i.e. with a human footprint index =
`r round(pred_data_explanation$hft_ix_c93["max"],1)`) displaying a total
abundance `r abun_rich_hft93_int_max["log_chao_richness"]` lower than ‘intact’
sites (i.e. with a human footprint index =
`r round(pred_data_explanation$hft_ix_c93["intact"],1)`). In contrast, we found
that past anthropogenic pressures resulted in higher species richness 
(Fig. 3c, orange), with the most degraded sites displaying `r
abun_rich_hft93_int_max["log_chao_richness"]` more species than intact sites.
Sites subject to a higher degree of past anthropogenic pressures also
had a higher proportion of non-native richness and non-native abundance (strong
evidence, Fig. 3c), such as the most degraded sites had a proportion of
non-native species richness (`r scales::percent(pred_hft93_t0$perc_exo_sp$val["max"])`)
twice higher than intact sites
(`r scales::percent(pred_hft93_t0$perc_exo_sp$val["intact"])`), and a
proportion of non-native species abundance three times higher
(`r scales::percent(pred_hft93_t0$perc_exo_abun$val["max"])` and
`r scales::percent(pred_hft93_t0$perc_exo_abun$val["intact"])` respectively).
In contrast, we found strong evidence that recent increases in
anthropogenic pressures were associated with communities displaying on average
lower total abundance and species richness but an increased share of nonnative
species. For instance, sites that had been subject to a recent two-fold increase
in anthropogenic pressures displayed total abundance
...
that had not undergone recent degradations, but a proportion of non-native
species richness and abundance more than half higher
(resp. `r other_hft9309_0_inc_by2["perc_exo_sp"]` and 
`r other_hft9309_0_inc_by2["perc_exo_abun"]`). Beyond human pressures,
we found strong evidence that community metrics varied along the longitudinal
stream gradient, such as the most downstream sites displayed three times more
species than the most upstream sites, as well as a proportion of non-native
species richness `r other_riv_int_max["perc_exo_sp"]` and of non-native species
abundance `r other_riv_int_max["perc_exo_abun"]` higher (Fig. 3c).
...
reported for freshwater insects[@van_klink_meta-analysis_2020]. It is also consistent with other regional
assessments of freshwater animal populations, such as the reported increase in
freshwater insect occupancy found in the UK or the increase in freshwater animal
LPI (Living Planet Index) in the Netherlands since the
1990s[@outhwaite_complex_2020; @van_strien_modest_2016]. Nonetheless, this
finding also contrasts with dramatic LPI declines of freshwater megafishes and
megafauna reported at the global scale and with other regional
assessments of fish assemblages [e.g., @he_global_2019]. We found that these
contrasted community changes could be traced back to the spatio-temporal changes
in human pressures and the position of the sites along the longitudinal stream
gradient. Indeed, higher past anthropogenic pressures were associated with a
larger increase in species richness and total abundance over time, suggesting a
recovery from the legacy of past disturbances. Previous studies suggested that
the adoption of numerous legislations targeting improvements in water quality in
the E.U. and the U.S. since the 1970s, as well as a decrease in the negative
effects of agriculture could be partly responsible for those increases despite
the surrounding habitat changes[@langford_long-term_2009; @van_klink_meta-analysis_2020;
@outhwaite_agriculture_2022]. The fact that most of our monitored
sites (92%) could be considered in an initial state of degradation at the
beginning of the study period, i.e. had a human footprint index superior to four
in 1993[@williams_change_2020], could therefore lend support to the recovery hypothesis.


However, higher past anthropogenic pressures resulted in a greater increasing
share of non-native species, especially in downstream areas, which suggests that
non-native species contribute disproportionately to the temporal changes
observed in riverine fish communities. In particular, the increase in local
species richness over time could result from the differential between
introduction and extirpation from on-going spatial
homogenization[@villeger_homogenization_2011], as predicted by metacommunity
models[@mouquet_community_2003] and observed in the Nearctic and Palearctic
...
footprint index - can result in higher non-native species richness by increasing
the number and the frequency of introduction events, i.e. propagule
...
non-native species that are often ubiquitous and
generalists[@tonella_importance_2018; @su_morphological_2020] by modifying
environmental conditions, and giving them a competitive advantage over native
species that are less adapted to the new conditions[@bernery_freshwater_2022;
@byers_impact_2002; @olden_life-history_2006; @haubrock_two_2021]. A higher degree of past
anthropogenic pressures also resulted in higher rates of species replacement and
changes in species dominance over time. Taken together, this suggests that the
legacy effects of past habitat degradation characterized by shifts in dominant
species and species identity towards species that are better adapted to degraded
environments and to which non-native species contribute
disproportionately[@toussaint_historical_2014; @kuczynski_concomitant_2018].
However, a more definitive interpretation of those increases in species richness
and total abundance in freshwater systems would require a precise assessment of
habitat quality and of the tolerance of the species composing the communities in
the areas in a degraded state, as native tolerant species might also contribute
to the on-going changes[@mccune_gains_2013]. In this respect, considering
species characteristics such as the degree of anthropophily, habitat
preferences, feeding preferences, may provide a more direct assessment of how
the degree of ubiquity and generalism changed over time in these communities.
Overall, the concordance between our results at local scale and the previously
reported on-going community homogenization at regional scale highlights that
linking biodiversity changes across spatial scales is crucial to understand why
reported local gains and global declines in biodiversity are not
contradictory[@vellend_plant_2017; @primack_biodiversity_2018;
@mcgill_fifteen_2015].

Our results further show that the interactions between past and recent changes
in anthropogenic pressures also drive community changes, highlighting the
importance of considering both the degree and timing of human pressures. For
instance, the increase in total abundance in the most historically degraded
sites was not observed when these sites were exposed to a recent increase in
anthropogenic pressures. In addition, past and recent anthropogenic pressures
had a synergistic effect on the share of non-native species richness and
abundance. This suggests that habitat degradation can result in both negative
effects on natives but positive effects on non-natives. Community changes over
space, i.e. the space-for-time substitution which assumed to display long-term
effect, confirm those antagonistic effects of anthropogenic pressures.  Indeed,
the most historically degraded sites were characterized by a higher number of
species, whereas the sites that had experienced a recent increase in
anthropogenic pressures displayed a comparatively lower number of species.
However, both the sites most historically degraded and those that underwent
recent increases in anthropogenic pressures displayed a lower total abundance.
This is in accordance with the abundant literature showing that land degradation
has detrimental effects on both vertebrate and invertebrates species richness
and total abundance over space[@newbold_global_2015;
@outhwaite_agriculture_2022]. In the same line, while past and recent changes 
in anthropogenic pressures had no effect on the proportion of non-native species
abundance trends over time, the historically or recently degraded sites
displayed overall higher proportion of non-native species abundance. This can be
explained by the residence time of non-native species between its first recorded
introduction and its eventual establishment success[@bernery_freshwater_2022],
which includes time for biological acceptance and local adaptation for example.
...
in marine and terrestrial communities. We uncovered different community
trajectories characterized by changes along only one or several biodiversity
dimensions, i.e. changes in species richness, total abundance, turnover or
medium/low community changes over time. Those contrasted community trajectories
likely result from the complex mosaic in the degree and timing of anthropogenic
pressures. For example, the clusters that are related to temporal increases in
total abundance and species richness likely correspond to sites historically
degraded. The second cluster may be related to recent increases in anthropogenic
pressures in historically degraded sites that resulted in slow increase in
species richness and total abundance, but a strong turnover, i.e. species
replacement, due in part by the establishment of non-native species. The
community trajectories related to a decline in total abundance but not in
species richness may then correspond to sites that experienced a particularly
strong recent increase in anthropogenic pressures. The location of the sites
along the stream gradient also explained some variability in the temporal
biodiversity trends, with the downstream sites experiencing faster rates of
community changes over time. It may be explained by the higher connectivity of
downstream sites with other tributaries, which in turn gives more opportunity
for local colonization[@altermatt_river_2013]. The stream gradient position was
also found to interact with the degree of anthropogenic pressures, decreasing or
enhancing the temporal biodiversity changes depending on the community metric
considered. It is then not surprising that community changes were found to be
more heterogeneous at the local scale than at the basin and realm scales. It may
reflect the characteristics of riverine habitats, and especially their dendritic
structure and isolation within drainage basins, which in turn determine
environmental filtering and dispersal opportunities[@dias_global_2014;
@altermatt_river_2013]. Furthermore, we found that the spatial structure of the
model captured much more variance in the community metrics than the fixed
effects, confirming previous findings[@chase_embracing_2018]. It might be
related to differences in community composition arising from environmental
drivers not included in our models such as biogeographical factors related to
post-glaciation fish colonization and climatic factors[@dias_global_2014]. It
may also be related to the relative coarseness of the anthropogenic pressures,
for instance the fact that the specific threats composing the index may have
different effects on fish communities, the influence of other threats such as
human-driven flow alteration[@reid_emerging_2019], and also climate change that
have been shown to interact with land-use in driving community
reorganization[@comte_climate_2021; @outhwaite_agriculture_2022].

Our study uncovered the complex associations between community changes and
anthropogenic pressures in riverine fish communities over space and time. We
showed that depending on their timing, human pressures can have antagonistic
effects on species richness and abundance, partly mediated by non-native
species. Whereas our results indicate that the global increases in species
richness and abundance were accompanied by rapid decreases in community
similarity, assessing the direct link between local community changes and biotic
homogenization among sites is a promising area of investigation, in line with
previous findings[@leprieur_fish_2008; @villeger_homogenization_2011;
@toussaint_historical_2014; @kuczynski_concomitant_2018]. Given that our study
has a spatial coverage limited to historically industrialized countries but that
the highest recent increases in anthropogenic pressures happened in current
biodiversity hotspots[@venter_global_2016], our findings suggest that they are
resulting in strong declines in total abundance and species richness.  As
spatial coverage increases, more dramatic local community changes may
emerge[@leprieur_fish_2008; @he_global_2019]. Our study further highlights that
considering human pressures and multiple biodiversity facets can help us to
understand the heterogeneity of community trajectories. The increasing
availability of community timeseries and of environmental data across large
areas is therefore invaluable to understand how human pressures have affected
and persist to affect biodiversity across taxa and ecosystems.
...
from Canada and United States (Table S2), following the same criteria than
...
Fig. S4 for the complete distribution).
...
and the United States (`r per_pays["USA"]`, Table S3).
...
individuals per 100 $m^2$ (`r u_per["Ind.100m2"]`), Catch Per Unit Effort (`r
u_per["CPUE"]`), and Leslie index (`r u_per["Leslie_index"]`, Table S3).
...
preventing us to harmonize count, abundance density and Catch Per Unit
...
both raw variables and log transformed ones, Fig. S5).
...
database of Tedesco et al.[@tedesco_global_2017] (`r nat_per["tedesco"]` of the species
occurrences). For the sites falling outside of the river basins provided in
the Tedesco database[@tedesco_global_2017], such as
...
criterion[@kaiser_varimax_1958], to increase the quality of
...
`r perc_var_rc1` of the variance (Fig. S6), and then was used as a composite
...
level such as the temporal trends in total abundance in the main text and
supplementary materials are expressed in raw count. We modelled dissimilarity
metrics with the intercept fixed at zero as dissimilarity metrics at each site
was 0 at the beginning of the time series.  Furthermore, we did not include the
main effects of ecological drivers ($\sum_{k=1}\beta_kX_k$ term from eq.
\@ref(eq:gen)) in the modelling of dissimilarity metrics, i.e. we only included
the effects of ecological drivers on the temporal trends. We did so because
dissimilarity metrics were relative to the site and bounded between 0 and 1, so
...
using a beta distribution). In addition, a similar study[@blowes_geography_2019] previously found
...
on Markov chains and Monte Carlo simulations, and then is a computationally
...
falls in a given interval, to the difference with frequentist
approach[@greenland_statistical_2016]. We computed the credible intervals at
80%, 90% and 95% using Highest Posterior Density
...
each observation, we computed $R^2$ values associated to each observation to
obtained the $R^2$ distribution [@gelman_r-squared_2019]. We then reported
the mean marginal and conditional $R^2$ associated the 95% credible
...
Linear Unbiased Prediction method. We did not the temporal trends of the
variables describing composition of non-native species as the they are part of
biodiversity[@schlaepfer_non-native_2018] and the temporal trends in the proportion of
non-native species displayed little variation compared to other variables, then
it was of little interest to include them in the dimensionality analysis.
...
the number of community metrics. To choose a relevant number of clusters, we
plotted the trimmed log-likelihood of the function as a function of the
proportion of the most outlying data trimmed ($\alpha$) (Fig. S9). We thus
selected a partition of temporal community changes in six clusters with
$\alpha=5\%$ (See Fig. S10 with four clusters). We did not constraint the algorithm for the relative size of shape
...
```{r}
map_cl_cap <- "**Spatial distribution of community trajectories**.
...
iv) Cluster frequency distribution in the three most represented Realms (in
...
between parentheses. Site not assigned to a cluster (N = 630, see Methods) are
not displayed. See supplementary material for an interactive world map of the cluster distribution." %>%
str_replace_all("  ", " ") %>%
str_replace_all("\n|\r", " ")
```

```{r}
tab_rand_cap <- " Mean conditional R-squared of the models and the mean standard
deviation estimated for the random temporal trends. [95\\% CI]: Credible Interval
computed using Highest Posterior Density method." %>%
str_replace_all("  ", " ") %>%
str_replace_all("\n|\r", " ")
```


- Figure 1: `r knitr::knit(text = pca_clust_cap)` 

- Figure 2: `r knitr::knit(text =  map_cl_cap)`

- Figure 3: `r knitr::knit(text =fig1_cap)`

- Table 1: `r knitr::knit(text = tab_rand_cap)` 

# Figures


```{r eff, fig.asp = .9, fig.width = 88* 0.0393701}
#, fig.cap=fig1_cap
knitr::include_graphics(here("paper", "fig_paper", "fig2.pdf"))
```

```{r, fig.asp = .65, fig.width = 88 * 0.0393701}
# , fig.cap=pca_clust_cap
knitr::include_graphics(here("paper", "fig_paper", "fig3_alt.pdf"))
```

```{r cl-map, fig.asp = 2.5, fig.width = 88* 0.0393701}
