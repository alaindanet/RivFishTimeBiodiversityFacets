...
legacy of the past as well as its recent changes.

Here, we explore the effects of anthropogenic pressures, in space and time, on
fish riverine communities. We used the RivFishTime database which gather
more than ten thousands timeseries of fish communities composition and
abundances, monitored mainly in Western and Northern Europe, Northern Eastern
America, South Eastern Australia and Japan. Following data selection (See
Methods), median baseline and completeness of the time series were respectively
1997 and 50% (Table SX, Fig. SX). We
quantified anthropogenic pressures with the human footprint index, which
includes human population density, land-use, and human built infrastructures
such as roads, railways, electric grids, and navigable pathways
[@venter_global_2016]. Previous studies reported that higher human footprint
index is related to higher extinction risk in terrestrial mammals, and that it
better predicts mammal distribution range than environmental predictors 
...
1993 [@williams_change_2020]. Past anthropogenic pressures also resulted in an
...
pressure addition decreases the temporal trends of species richness and total
...
medium/low temporal changes. This results is in accordance with previous studies
...
over time. It is is in line with the global increase of species richness and
...
strongest increase in species richness, strongest decrease in total abundance,
and strongest decrease in species richness over time, all of them were not
...
[@dornelas_assemblage_2014; @blowes_geography_2019;
@van_klink_meta-analysis_2020; @newbold_global_2015; @cardinale_is_1998]. By
...
change [@comte_land_2021; @outhwaite_agriculture_2022], as well as a complement
