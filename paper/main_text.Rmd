...
- TODO: 
  - GLMMTMB verifier R2: function does not work on glmmTMB object but I checked
    the function and the formula is the same that I used
  - human footprint index / non-native richness
...
favor the success of non-native species etablishment via rapid disturbance,
...
Legacy of past antropogenic pressures result in a larger increase over time in
...
communities is really close from the one found in a recent metanalysis in
freshwater insects at global scale, i.e. +13% by decade vs +11% by decade in
@van_klink_meta-analysis_2020. This result also corrobates with the increasing
occupancy of freswater species found in UK since 1994
...
reinforcements from the 1980s to the 2000s. Further in agreement with this
hypothesis, 92% of the sites included in the present study can be considered as
degraded, i.e. had a human footprint index superior to four in 1993
[@williams_change_2020]. Past anthropogenic pressures also resulted in an
...
past anthropogenic pressures    increase temporal dissimilarity, mainly by
species replacement, i.e. turnover, and changes in species dominance structure.
This result is in line with the recovery in terms of total abundance, species
richness and proportion of exotic species, suggesting that it underlines strong
resuffling of fish riverine  communities.

We found that the more that a site was already degraded, the more a recent
pressure addition decreases the temporal trends of species richness and total
abundance, highlighting that recent and past antropogenic pressures have an
...
most degraded. We also found recent increase in antropogenic pressures
increases in turn the proportion of non-native species richness as for past
...
together, those results are in accordance with the mounting body of litterature
highlighting the importance of the stressors timing on the dynamic of ecological communities 
[@mccomb_editorial_2020; @brooks_combined_2019; @orr_towards_2020]

- Add human footprint papers



- Both past, recent pressures and their interactions increase temporal
  dissimilarity
- We observe stronger recovery in species richness and abundance in sites more
  degraded 30 years ago
...
- Recent increase in human pressures left a strong spatial signature on richness
  and abundance, confirming previous results on 
