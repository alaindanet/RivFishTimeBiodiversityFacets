...
- TODO: 
  ...
  - [ ] Supplementary
    - [x] Grosse table avec toutes les variables, main text names, les distributions
    - [x] refaire graph correspondance données / dates des human footprint index
  ...
  - [ ] Review figures:
    - [x] Check PCA axis contribution: it is the varimax rotation of the PC that
      ...
      - [x] Replace by non rotated PCA? 
      - [x] Update results
    - [x] Figure 
      - [x] fig 3: enlever l'antartique, agrandir la carte du monde, enlever les pays
      ...
      - [x] Review all figure comments 
  - [x] Table random effects + both R-squared in main text (cf figures.pdf)
