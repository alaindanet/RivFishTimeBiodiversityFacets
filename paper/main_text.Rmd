...
(Fig. 3c, orange), with the most degraded sites displaying 
`r abun_rich_hft93_int_max["log_chao_richness"]` more species than intact sites.
...
(`r scales::percent(pred_hft93_t0$perc_exo_sp$val["max"])`)
...
lower total abundance and species richness but an increased share of non-native
