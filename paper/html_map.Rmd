...
```{r}
tar_load(c(site_cl_rm, site_cl_na, filtered_dataset_modelling))
...
```{r}
mapshot(m,
  url = here("paper", "fig_paper", "cluster_trends10y_map.html"),
  selfcontained = FALSE
)
```
