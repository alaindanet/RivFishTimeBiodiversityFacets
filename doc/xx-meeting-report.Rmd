...
pca_clust <- compute_rotated_pca(site_no_drivers_inla)
...
fig2_right <- plot_grid(
  main_map_rect, p_zoom_map$south_eu, p_zoom_map$north_eu,
  p_zoom_map$north_am, p_zoom_map$eng, p_zoom_map$aus,
  ncol = 3, axis ="l"
)

save_plot(
  here("doc", "fig", "fig2_right.png"),
  fig2_right,
  base_height = 3.71,
  base_asp = 2.618,
)
